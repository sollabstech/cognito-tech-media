...
export function CtaBand({
  ...
  return (
    <section className="section">
      <div className="shell">
        <Reveal>
          <div className="relative overflow-hidden rounded-4xl border border-white/10 bg-gradient-to-br from-brand-700/40 via-ink-raised to-ink px-6 py-12 text-center sm:px-12 sm:py-16">
            <div
              aria-hidden
